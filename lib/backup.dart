                            ...
                            onPressed: () {
                              if (currentIndex < onboardingData.length - 1) {
                                ...
                                showGeneralDialog(
                                  ...
                                  barrierColor:
                                      Colors.black54, // dark overlay background
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: ElevatedButton(
                                                      onPressed: () async {
                                                        ...
                                                        print(
                                                          "Sending data: $fullName, $email, $password",
                                                        );
                                  ...
                                  transitionBuilder:
                                      (context, animation1, animation2, child) {
                                        final curved = CurvedAnimation(
                                          parent: animation1,
                                          curve: Curves
                                              .easeInOut, // smooth spring-like curve
                                        );
